...
> 最後更新：2026-04-12 11:35 CST
> 任務總數（14天）：107 條｜未完成：0 條｜重要記憶：41 條
...
### 📅 2026-04-12 [bug_fix] Gallery 兩個 bug 已修復並重啟
✅ Gallery 兩個 bug 已修復並重啟 Bug 1 — 相簿點進去 404： 已確認 browseAlbum() 用 a.id 傳入，loadAlbumPhotos 用 currentBrowsingAlbumId 組 API URL。 驗證：/api/albums/52/photos → 13 張，OK ✓ Bug 2 — 相簿 grid 靠左黑色空白： 動態欄數已修好（1400px...
